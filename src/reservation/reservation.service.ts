...
export class ReservationService {
  ...
  async create(createReservationDto: CreateReservationDto, user_id: number) {
    try {
      ...
      newTransaction.status = STATUS.unpaid;
  ...
  //hotelier
  async getReservationById(hotel_id: number) {
    const hotel = await this.hotelRepository.findOne({
      where: {
        hotel_id,
      },
  ...
  async remove(id: number) {
   ...
   /////////USER
   async cancelReservation(id: number, UpdateReservationDto: UpdateReservationDto) {
  ...
  //// Hotelier
  async accept (id: number, UpdateReservationDto: UpdateReservationDto) {
